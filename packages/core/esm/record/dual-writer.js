...
export var DualWriter = /*#__PURE__*/function () {
  function DualWriter(opts) {
    _classCallCheck(this, DualWriter);
    this.opts = opts;
  }
  _createClass(DualWriter, [{
    key: "storeL1",
    value: function () {
      ...
      function storeL1(_x) {
        return _storeL.apply(this, arguments);
      }
      return storeL1;
    }()
  }, {
    ...
    value: function () {
      ...
      function deprecateL1(_x2) {
        return _deprecateL.apply(this, arguments);
      }
      return deprecateL1;
    }()
  }]);
